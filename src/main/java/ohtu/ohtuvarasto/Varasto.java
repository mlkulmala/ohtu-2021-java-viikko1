...
public class Varasto {
    ...
    public Varasto(double tilavuus, double alkuSaldo) {     // kuormitetaan
        ...
        this.saldo = laskeTodellinenSaldo(tilavuus, alkuSaldo);
    }

    public double laskeTodellinenSaldo(double tilavuus, double alkuSaldo) {
        if (alkuSaldo < 0.0) {               // alkusaldo ei voi olla negatiivinen
            return 0.0;
